...
class EmoTalk(nn.Module):
    def __init__(self, args):
        ...
        self.audio_encoder_cont = Wav2Vec2Model.from_pretrained("models/wav2vec2-large-xlsr-53-english")
        self.processor = Wav2Vec2Processor.from_pretrained("models/wav2vec2-large-xlsr-53-english")
        ...
        self.audio_encoder_emo = Wav2Vec2ForSpeechClassification.from_pretrained(
            "models/wav2vec-english-speech-emotion-recognition")
